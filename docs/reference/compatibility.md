...
release verification. Compatibility means Chattice's curated public
...
parses representative payload fixtures, builds the generated reference,
and keeps unknown-event/raw fallbacks forward-compatible. A scheduled workflow
compares the live discovery schema, official release feed, and SDK versions
against the reviewed baseline and opens an issue when they change.
