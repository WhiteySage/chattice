...
User=echo-bot
WorkingDirectory=/opt/echo-bot
Environment=CHATTICE_SUBSCRIPTION=projects/<project>/subscriptions/<sub>
...
app.include_router(
    create_pubsub_router(
        ...
        verifier=GooglePubSubVerifier(
            ...
            service_account_email=os.environ["PUBSUB_SERVICE_ACCOUNT_EMAIL"],
        ),
...
updates — update cards via `bot.app.messages.update(name, card=...)`
afterwards.
