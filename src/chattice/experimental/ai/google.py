...
The adapter bridges Chat context to google-genai and
...
class GeminiAgentBackend:
    ...
    through `generation_kwargs` raises at construction, and forbidden keys
    are re-filtered at the final provider boundary as defense in depth. When tools
    ...
    async def run(
        ...
        *,
        ...
        if tools is not None:
            ...
            # Automatic function execution is intentionally disabled.
