"""FSM record storage: compare-and-set, TTL, and mapping adapter."""
...
# --------------------------- mapping adapter over a record store
...
async def test_redis_lazy_expiry_never_deletes_replacement() -> None:
    """A stale reader cannot delete a concurrent writer's replacement."""
    import fakeredis.aioredis
...
async def test_redis_expiry_forced_stale_read_interleaving() -> None:
    """A replacement survives a forced stale-read interleaving."""
    import asyncio
