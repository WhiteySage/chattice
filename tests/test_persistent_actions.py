"""Persistent and stateless actions survive process restarts."""
...
async def test_action_routes_after_fresh_application() -> None:
    ...
    # Simulate a process restart by building a new application instance.
    first = _build_app()
    assert (
...
async def test_card_from_old_version_still_routes() -> None:
    ...
    # Simulate the alternate serialized payload shape.
    old_payload = {
        "type": "CARD_CLICKED",
        "eventTime": "2000-01-01T09:00:00Z",
        "user": {"name": "users/1"},
        "space": {"name": "spaces/AAA"},
