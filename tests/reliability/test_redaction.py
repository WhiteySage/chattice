...
async def test_handler_exception_messages_never_reach_logs() -> None:
    """Handler exception messages cannot reach framework logs."""
    import logging
...
async def test_verifier_exception_messages_never_reach_logs() -> None:
    """Verifier failures log only the exception class."""
    import logging
...
async def test_lifespan_close_errors_log_class_only() -> None:
    """Lifecycle resource failures must not expose exception messages."""
    import logging
