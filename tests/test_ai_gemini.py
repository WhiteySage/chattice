"""Gemini policy inputs and provider resource ownership."""
...
async def test_mutation_after_construction_cannot_add_forbidden_keys() -> None:
    """Later caller mutations cannot inject tool configuration."""
...
async def test_defense_in_depth_re_filter_at_provider_boundary() -> None:
    """Even if an intermediate layer rewrites the frozen mapping,
