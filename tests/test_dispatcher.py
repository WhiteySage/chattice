...
def test_public_api_exports_are_intentional() -> None:
    ...
    assert chattice.__version__ == _pyproject_version()


def _pyproject_version() -> str:
    """Track the version declared in pyproject.toml instead of pinning a
    literal here, so a release does not require editing this test."""
    import tomllib
