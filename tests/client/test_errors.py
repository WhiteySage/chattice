...
@pytest.mark.parametrize(
    ...
    [
        ...
        (api_core_exceptions.AlreadyExists, "already exists", ChatAlreadyExistsError),
        (api_core_exceptions.Conflict, "conflict", ChatAlreadyExistsError),
...
def test_hierarchy_subclasses_base() -> None:
    ...
    assert issubclass(ChatAlreadyExistsError, ChatAPIError)
